...
sudo su -c "rm -f /home/pivotpde/hdphosts.txt"

echo "setting hostname for ambari node and restarting network..."
sudo su -c "hostname edgenode.hawqdatalake.com"
sudo su -c 'echo "10.0.0.4	edgenode.hawqdatalake.com	edgenode" >> /home/pivotpde/hdphosts.txt'
...
do
    ...
    sudo su -c "echo '10.0.0.$startIp       $mhostfqdn      $mhost' >> /home/pivotpde/hdphosts.txt"
   ((startIp = startIp + 1))
done
...
do
    ...
    sudo su -c "echo '10.0.0.$startIp       $dhostfqdn       $dhost'  >> /home/pivotpde/hdphosts.txt"
   ((startIp = startIp + 1))
done
...
do
   scp /etc/hosts 10.0.0.$startIp:~/
   ssh 10.0.0.$startIp 'sudo su -c "cp /home/pivotpde/hosts /etc/hosts" '
